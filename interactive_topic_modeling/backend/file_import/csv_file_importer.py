...
class CsvFileImporter(file_importer_base.FileImporterBase):
    ...
    def compatible_file(self, path: str) -> bool:
        ...
        with open(path, 'r', newline="") as csvfile:
            ...
            # This might not be necessary, as the following fieldnames check
            # _probably_ would not succeed if the csv file doesn't start with headers
    ...
    def generate_file(self, file: dict) -> File:
        ...
        return File(body=file.get("body"), author=file.get("author"),
                    ...
                    url=file.get("url"), path=file.get("path"))
