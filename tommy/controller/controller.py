...
from tommy.controller.model_parameters_controller import ModelParametersController
...
from tommy.controller.project_settings_controller import ProjectSettingsController
...
class Controller:
    ...
    def new_model():
        ...
        ModelParametersController.set_model_parameters_model(new_model.model_parameters_model)

        GraphController.set_model_parameters_model(new_model.model_parameters_model)

        TopicModellingController.set_model_parameters_model(new_model.model_parameters_model)
        ...
        CorpusController.set_project_settings_model(new_model.project_settings_model)

        ProjectSettingsController.set_project_settings_model(new_model.project_settings_model)
