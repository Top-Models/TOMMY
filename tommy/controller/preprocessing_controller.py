...
class PreprocessingController:
    ...
    def __init__(self) -> None:
        ...
        self._entity_categories = {"PERSON", "FAC", "LAW", "TIME", "PERCENT", "MONEY", "QUANTITY", "ORDINAL", "CARDINAL"}
    ...
    def process_tokens(self, doc: Doc) -> list[str]:
        ...
        lemmas = [token.lemma_ for token in doc if token.ent_type_ not in self._entity_categories and token.pos_ in self._pos_categories]
